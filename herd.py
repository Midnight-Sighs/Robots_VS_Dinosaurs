...
squish_dino_one = Dino("squish","Ceolophysis","Squish",80,0,10 )
squish_dino_two = Dino("squish","Ceolophysis","Squeeze",80,0,10 )
basic_dino = Dino("basic", "Dilophosaurus", "Spite", 100, 5, 0)
tank_dino_one = Dino("tank", "Allosaurus", "Frankie", 120, 10, 5)
tank_dino_two = Dino("tank", "Allosaurus", "Freaky", 120, 10, 5)
...
class Herd:    
    ...
    def assign_computer_to_herd(self):
        self.list = balanced_list
